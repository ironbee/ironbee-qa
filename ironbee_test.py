...
if __name__ == "__main__":
    ...
    parser.add_option("--apache-vars", dest="apache_var_string",default="@CWD@:%s,@IRONBEE_TESTS_DIR@:%s/tests,@IRONBEE_CONF_TEMPLATE@:%s/apache_httpd_server_root/conf/ironbee.conf.in,@APACHE_HTTPD_CONF_TEMPLATE@:%s/apache_httpd_server_root/conf/httpd.conf.in,@IRONBEE_SERVERROOT_DIR@:%s/apache_httpd_server_root,@IRONBEE_LOGS_DIR@:%s/apache_httpd_server_root/logs,@APXS_LIBEXECDIR@:/usr/lib/apache2/modules,@IRONBEE_DOCROOT_DIR@:%s/apache_httpd_server_root/htdocs,@IRONBEE_COREDUMP_DIR@:%s/apache_httpd_server_root/tmp" % (os.getcwd(),os.getcwd(),os.getcwd(),os.getcwd(),os.getcwd(),os.getcwd(),os.getcwd(),os.getcwd()), type="string", help="List of variable replacements for use in conjunction with --local-apache. Defautls are @CWD@:%s,@IRONBEE_TESTS_DIR@:%s/tests,@IRONBEE_CONF_TEMPLATE@:%s/apache_httpd_server_root/conf/ironbee.conf.in,@APACHE_HTTPD_CONF_TEMPLATE@:%s/apache_httpd_server_root/conf/httpd.conf.in,@IRONBEE_SERVERROOT_DIR@:%s/apache_httpd_server_root,@IRONBEE_LOGS_DIR@:%s/apache_httpd_server_root/logs,@APXS_LIBEXECDIR@:/usr/lib/apache2/modules,@IRONBEE_DOCROOT_DIR@:%s/apache_httpd_server_root/htdocs,@IRONBEE_COREDUMP_DIR@:%s/apache_httpd_server_root/tmp" % (os.getcwd(),os.getcwd(),os.getcwd(),os.getcwd(),os.getcwd(),os.getcwd(),os.getcwd(),os.getcwd()))
