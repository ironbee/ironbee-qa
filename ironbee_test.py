...
if __name__ == "__main__":
    ...
    parser.add_option("--send-mode", dest="send_mode", default="raw_socket",type="string", help="how we send the request raw_socket, raw_socket_ssl, jnovak_send_rst_bad_chksum,jnovak_send_overlap_bad_chksum,jnovak_send_bogus_ecn_flags,jnovak_sequence_wrap,jnovak_multiple_syns,jnovak_rst_syn_again,jnovak_syn_pushflag,jnovak_syn_urgflag")
